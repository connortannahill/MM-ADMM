...
double HuangFunctional::operator()(Eigen::VectorXd &z, Eigen::VectorXd &grad) {
    Eigen::Vector2d zTemp(z);
    Eigen::Vector2d gradTemp(grad);
    double res = (*this)(zTemp, gradTemp, true);
